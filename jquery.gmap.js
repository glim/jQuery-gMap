...
(function($)
{
    ...
    $.fn.gMap = function(options, methods_options)
    {
        ...
        {
        case 'addMarker':
            return $(this).trigger('gMap.addMarker', [methods_options.latitude, methods_options.longitude, methods_options.content, methods_options.icon, methods_options.popup, methods_options.animation]);
        case 'centerAt':
